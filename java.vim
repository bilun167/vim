" Editing settings
set tabstop=2 shiftwidth=2 expandtab textwidth=90
...
inoremap <buffer> <C-_>C <C-V><code> inoremap <buffer> <C-_>c <C-V></code> " " Helpful mappings when creating a new object " " Type: Object o<F2> " " Get:  Object o = new Object();
